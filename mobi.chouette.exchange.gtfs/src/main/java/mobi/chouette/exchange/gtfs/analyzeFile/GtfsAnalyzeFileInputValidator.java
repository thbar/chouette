...
@Log4j
public class GtfsAnalyzeFileInputValidator extends AbstractInputValidator {
	...
	public static class DefaultFactory extends InputValidatorFactory {
		...
		protected InputValidator create() throws IOException {
			InputValidator result = new GtfsAnalyzeFileInputValidator();
			return result;
		}
	}

	static {
		InputValidatorFactory.factories.put(GtfsAnalyzeFileInputValidator.class.getName(), new DefaultFactory());
	}
