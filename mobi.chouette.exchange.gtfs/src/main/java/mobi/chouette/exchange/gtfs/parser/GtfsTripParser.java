...
//	}
	...
	protected void convert(Context context, GtfsTrip gtfsTrip, VehicleJourney vehicleJourney) {
        ...
        StopPoint arrivalStopPoint = vehicleJourney.getJourneyPattern().getArrivalStopPoint();
        ...
        if (gtfsTrip.getTripShortName() != null) {
            ...
            StopPoint departureStopPoint = vehicleJourney.getJourneyPattern().getDepartureStopPoint();
