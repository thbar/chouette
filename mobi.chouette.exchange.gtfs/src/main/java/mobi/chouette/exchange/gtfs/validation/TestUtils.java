...
public class TestUtils implements Constant{
	...
	private TestUtils() {
			...
			gtfsTestList.add(new TestDescription(1, GTFS_1_GTFS_Route_3, "WARNING"));
			...
			gtfsTestList.add(new TestDescription(2, GTFS_2_GTFS_Common_6, "ERROR"));
		...
		gtfsTestList.add(new TestDescription(2, GTFS_2_GTFS_Stop_1, "ERROR"));
			...
			gtfsTestList.add(new TestDescription(2, GTFS_2_GTFS_Stop_5, "ERROR"));
