...
public class Phase1AgencyTests extends AbstractPhase1Tests {
	...
	public void verifyTest_2_4_3() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "agency_4_3", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_4_4() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "agency_4_4", GTFS_1_GTFS_Common_9,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_5_2() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "agency_5_2", GTFS_1_GTFS_Common_12,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_6() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context ,"agency_6", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_7() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "agency_7", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_8() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "agency_8", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_9() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "agency_9", GTFS_1_GTFS_Common_16,SEVERITY.ERROR, RESULT.NOK,true);
	...
	public void verifyTest_2_10() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "agency_10", GTFS_1_GTFS_Common_11,SEVERITY.WARNING, RESULT.NOK,true);
	...
	public void verifyTest_2_11() throws Exception {
		...
		Context context = new Context();
		CheckPointReport result = verifyValidation( log, context, "agency_11", GTFS_1_GTFS_Common_5,SEVERITY.ERROR, RESULT.NOK,true);
