...
@Log4j
public class NeptuneAnalyzeFileInputValidator extends AbstractInputValidator {
	...
	public static class DefaultFactory extends InputValidatorFactory {
		...
		protected InputValidator create() throws IOException {
			InputValidator result = new NeptuneAnalyzeFileInputValidator();
			return result;
		}
	}

	static {
		InputValidatorFactory.factories.put(NeptuneAnalyzeFileInputValidator.class.getName(), new DefaultFactory());
	}
