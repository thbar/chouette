...
@Log4j
public class NetexprofileAnalyzeFileInputValidator extends AbstractInputValidator {
	...
	public static class DefaultFactory extends InputValidatorFactory {
		...
		protected InputValidator create() throws IOException {
			InputValidator result = new NetexprofileAnalyzeFileInputValidator();
			return result;
		}
	}

	static {
		InputValidatorFactory.factories.put(NetexprofileAnalyzeFileInputValidator.class.getName(), new DefaultFactory());
	}
