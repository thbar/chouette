...
public class FranceLineNetexProfileValidatorTest {
...
//		expectedResults.put(AbstractNorwayNetexProfileValidator._1_NETEX_TIMETABLE_FRAME_SERVICE_JOURNEY_TRANSPORT_MODE, NOK);
	...
	private void verifyAllCheckpointsCovered(ValidationReport vr, Map<String, RESULT> expectedResults) {
	...
	private void assertReported(ValidationReport vr, String checkpointKey, RESULT result) {
		boolean found = false;
