...
public class NavigationPathMapperTest {
    ...
    public void mapConnectionLinkStopPlace() throws DatatypeConfigurationException {
        ...
        // FIXME MHI : réparer NavigationPathMapper si nécessaire ou dégager le test.
//        Assert.assertEquals(navigationPath.getPathLinksInSequence().getPathLinkInSequence().get(0).getLinkSequenceRef(), link.getObjectId());
    }
