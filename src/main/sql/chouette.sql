...
CREATE TABLE access_links (
    ...
    default_duration character varying(255),
    frequent_traveller_duration character varying(255),
    occasional_traveller_duration character varying(255),
    mobility_restricted_traveller_duration character varying(255),
...
CREATE TABLE journey_frequencies (
    ...
    scheduled_headway_interval character varying(255) NOT NULL,
